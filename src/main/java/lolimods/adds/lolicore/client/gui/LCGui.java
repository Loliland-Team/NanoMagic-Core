...
public class LCGui extends GuiScreen implements IScreenDrawable {
	...
	public LCGui(@Nullable ResourceLocation bg, int sizeX, int sizeY) {
		this.bg = bg;
		this.sizeX = sizeX;
		this.sizeY = sizeY;
	...
	public LCGui(@Nullable ResourceLocation bg) {
		this(bg, 176, 166);
	}
	...
	protected void keyTyped(char typed, int keyCode) throws IOException {
		if (components.handleKeyTyped(typed, keyCode))
