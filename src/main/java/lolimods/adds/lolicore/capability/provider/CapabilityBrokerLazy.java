...
import lolimods.adds.lolicore.capability.provider.CapabilityBroker;
...
public class CapabilityBrokerLazy extends CapabilityBroker {
	...
	public boolean hasCapability(@Nonnull Capability<?> capability, @Nullable EnumFacing facing) {
		return super.hasCapability(capability, facing) || (!closedSet.contains(capability) && tryLateResolve(capability) != null);
	}
