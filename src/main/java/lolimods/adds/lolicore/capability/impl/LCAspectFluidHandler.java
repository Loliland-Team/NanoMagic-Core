...
public class LCAspectFluidHandler implements IFluidHandler, ISerializable {
	private final boolean overflowProtection;
	private final FluidReservoir[] tanks;

	public LCAspectFluidHandler(boolean overflowProtection, FluidReservoir... tanks) {
		this.overflowProtection = overflowProtection;
		this.tanks = tanks;
	}

	public LCAspectFluidHandler(boolean overflowProtection, int tankCount, Supplier<FluidReservoir> tankFactory) {
