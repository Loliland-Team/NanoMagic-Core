...
import lolimods.adds.lolicore.item.LCItemSubs;
...
public class ItemUtils {
	...
	public static IDisplayableMatcher<ItemStack> matchesWithWildcard(ItemStack stack) {
		return IDisplayableMatcher.of(() -> stack.getMetadata() == WILDCARD_META ? new ItemStack(stack.getItem(), stack.getCount(), 0) : stack, s -> matchesWithWildcard(stack, s));
	}
	...
	public static String getColouredBlockName(WorldBlockPos pos) {
		return getColouredName(pos.getBlock().getPickBlock(pos.getBlockState(), null, pos.getWorld(), pos.getPos(), null));
	}

	@SuppressWarnings("deprecation")
	public static String getLocalizedSubName(LCItemSubs item, int meta) {
